...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    enabled: 'Enabled',
    active: 'Active',
    confirmEnableAll: 'Enable all clients?',
    confirmDisableAll: 'Disable all clients?',
    noPrivKey: 'No private key available',
  },
  ru: {
    name: 'Имя',
    password: 'Пароль',
    ...
    enabled: 'Включено',
    active: 'Активно',
    confirmEnableAll: 'Включить всех клиентов?',
    confirmDisableAll: 'Выключить всех клиентов?',
    noPrivKey: 'Приватный ключ недоступен',
  },
